...
//    private static final String BASE_URI = "http://localhost:9999/RestClientTest/resources";
    ...
    public String getPocet(String zmluva) throws ClientErrorException {
    ...
    public <T> T getXml(Class<T> responseType, String zmluva) throws ClientErrorException {
        WebTarget resource = webTarget;
        resource = resource.path(java.text.MessageFormat.format("{0}", new Object[]{zmluva}));
    ...
    public String postOsoba(Object requestEntity, String zmluva) throws ClientErrorException {
        return webTarget.path(java.text.MessageFormat.format("{0}", new Object[]{zmluva})).request(javax.ws.rs.core.MediaType.TEXT_PLAIN).post(javax.ws.rs.client.Entity.entity(requestEntity, javax.ws.rs.core.MediaType.TEXT_PLAIN), String.class);
    }

    public String getOsoba(String zmluva, String pid) throws ClientErrorException {
        WebTarget resource = webTarget;

...
////////////////////////////////////////////////////////////////////////////////
    ...
    public void UT13_Z123Majitel_2B() {
        assertNotNull("Ziadna zmluva po inite", z123);
        assertNotNull("Ziadny majitel po inite", z123.getMajitel());
        BODY++;
        assertEquals(MAJITEL, z123.getMajitel().getMeno());
        assertEquals(RC, z123.getMajitel().getRc());
        assertNotNull("Ziadny adresa po inite", z123.getMajitel().getAdresa());
        assertTrue("Nespravna adresa po inite",z123.getMajitel().getAdresa().startsWith(ADRESA));
        BODY++;
    }
...
// nove poistenie
    ...
    public void UT23_PP1Majitel_2B() {
        assertNotNull("Ziadne PP1", pp1);
        assertNotNull("Ziadny majitel", pp1.getMajitel());
        BODY++;
        assertEquals("Porik", pp1.getMajitel().getMeno());
        assertEquals("1212", pp1.getMajitel().getRc());
        assertEquals("Polna", pp1.getMajitel().getAdresa());
        BODY++;
    }
    ...
    public void UT43_Z123DeletePosledne_1B() {
        pp1 = null;
        try {
            pp1 = client.getZmluva(Poistenie.class, IDZMLUVY);
        } catch (Exception e) {
            //neocakavana chyba");
            fail("CHYBA WEB:" + e.getMessage());
        }
